...
public class BirthdayServiceAcceptanceTest {
    ...
    public void setUp() throws Exception {
        ...
        FileEmployeesRepository employeesRepository = new FileEmployeesRepository(EMPLOYEES_FILE_PATH);
        GreetingsSender greetingsSender = new FakeEmailGreetingsSender(FROM, SMTP_HOST, SMTP_PORT, messagesSent);

        service = new BirthdayService(employeesRepository, greetingsSender);
    }
